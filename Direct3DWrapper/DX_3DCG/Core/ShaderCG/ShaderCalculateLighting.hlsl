...
//////////////////////////////////////フォン鏡面反射/////////////////////////////////////////////////////
float3 Phong(float distAtten, float3 lightCol, float3 SpecularCol, float3 Nor, float3 LVec,
...
//角度減衰率スペキュラ
    ...
    return distAtten * lightCol * angleAttenSpe * SpecularCol;
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////

//////////////////////////////////////ライト計算/////////////////////////////////////////////////////////
LightOut LightCom(float3 SpecularCol, float3 Diffuse, float3 Ambient, float3 Nor,
...
//スペキュラ出力
    Out.Specular = Phong(distAtten, lightCol, SpecularCol, Nor, LVec, wPos, eyePos, shininess);
    return Out;
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////

///////////////////////ポイントライト計算(ライト数分ループさせて使用する)////////////////////////////////
LightOut PointLightCom(float3 SpecularCol, float3 Diffuse, float3 Ambient, float3 Nor,
...
//光源計算
        Out = LightCom(SpecularCol, Diffuse, Ambient, Nor,
...
///////////////////////ポイントライト計算, 距離減衰無し///////////////////////////////////////////////////
LightOut PointLightComNoDistance(float3 SpecularCol, float3 Diffuse, float3 Ambient, float3 Nor, 
...
//光源計算
    return LightCom(SpecularCol, Diffuse, Ambient, Nor,
                    wPos, lightCol, eyePos, lightVec, distAtten, shininess);
}
//////////////////////////////////////////////////////////////////////////////////////////////////////////

/////////////////////////////////////平行光源計算/////////////////////////////////////////////////////////
LightOut DirectionalLightCom(float3 SpecularCol, float3 Diffuse, float3 Ambient, float3 Nor, 
