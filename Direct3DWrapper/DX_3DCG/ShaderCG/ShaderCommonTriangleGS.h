...
"   TangentBinormal tan0 = (TangentBinormal)0;\n"
"   TangentBinormal tan1 = (TangentBinormal)0;\n"
"   TangentBinormal tan2 = (TangentBinormal)0;\n"
...
//接ベクトル計算
"   tan0 = GetTangentBinormal(nor0, Input[0].instanceID);\n"
"   tan1 = GetTangentBinormal(nor1, Input[1].instanceID);\n"
"   tan2 = GetTangentBinormal(nor2, Input[2].instanceID);\n"

"   p = PsInput(Input[0]);\n"
"   p.Nor = tan0.normal;\n"
"   p.tangent = tan0.tangent;\n"
"   p.binormal = tan0.binormal;\n"
"	triStream.Append(p);\n"
"   p = PsInput(Input[1]);\n"
"   p.Nor = tan1.normal;\n"
"   p.tangent = tan1.tangent;\n"
"   p.binormal = tan1.binormal;\n"
"	triStream.Append(p);\n"
"   p = PsInput(Input[2]);\n"
"   p.Nor = tan2.normal;\n"
"   p.tangent = tan2.tangent;\n"
"   p.binormal = tan2.binormal;\n"
"	triStream.Append(p);\n"
...
//接ベクトル計算
"   tan0 = GetTangentBinormal(Input[0].Nor, Input[0].instanceID);\n"
"   tan1 = GetTangentBinormal(Input[1].Nor, Input[1].instanceID);\n"
"   tan2 = GetTangentBinormal(Input[2].Nor, Input[2].instanceID);\n"
