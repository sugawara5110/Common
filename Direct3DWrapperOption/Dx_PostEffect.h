...
protected:
	...
	struct CONSTANT_BUFFER_PostMosaic {
		CoordTf::VECTOR4 mosaicSize_GausSize;//x:mosaicSize, y:GausSize
	...
	D3D12_GPU_DESCRIPTOR_HANDLE mGaussInOutHandleGPU;

	ComPtr<ID3D12Resource> mInputBuffer = nullptr;
	ComPtr<ID3D12Resource> mOutputBuffer = nullptr;
	ComPtr<ID3D12Resource> mGaussInOutBuffer = nullptr;
...
public:
	...
	void ComputeBloom(int com_no, bool On);
};
