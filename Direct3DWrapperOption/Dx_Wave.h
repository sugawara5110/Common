...
public:
	...
	void InstancingUpdate(float disp, float SmoothRange, float SmoothRatio = 0.999f, float shininess = 4.0f,
	...
	void Update(float speed, CoordTf::VECTOR3 pos, CoordTf::VECTOR4 Color,
		...
		float disp, float SmoothRange, float SmoothRatio = 0.999f, float shininess = 4.0f,
		float px = 1.0f, float py = 1.0f, float mx = 1.0f, float my = 1.0f);
